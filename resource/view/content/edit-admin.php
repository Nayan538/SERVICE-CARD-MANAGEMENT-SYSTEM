							...
							<div class="controls col-md-9">
								<div class="fileupload fileupload-new" data-provides="fileupload">
									<span class="btn btn-default btn-file">
										<input type="file" name="admin_image" class="default" onchange="readURL(this);" value="<?php echo $productDetails[0]['admin_image'];?> />
									</span>
							...
							<div class="col-md-9">
								<div class="fileupload fileupload-new" data-provides="fileupload">
									<div class="fileupload-new thumbnail" style="width: 160px; height: 160px;">
										<img style="height: 100%; width: 100%;" src="<?php echo $GLOBALS['ADMINS_DIRECTORY'] . $adminData[0]['admin_image']; ?>" alt="" id="blah"/>
									</div>
								</div>
							</div>
						</div>
